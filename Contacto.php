...
<?php
        if (isset ($_POST['guardar'])){
            ...
            if(!empty($nombre) and !empty($direccion) and !empty($telefono) and !empty($correo) and !empty($mensaje)){
                include("conexion.php");
                $conn=Conexion();

                echo $nombre;
    
                $query= "INSERT INTO user (nombre, direccion, telefono, correo, mensaje) VALUES('$nombre', '$direccion', '$telefono', '$correo', '$mensaje')";
                
                //$query= "INSERT INTO productos (producto, precio, cantidad) VALUES('$producto', '$precio', '$cantidad')";
    
                $result = mysqli_query($conn, $query) or die ('Error'. mysqli_error($conn));
    
                echo "<div class='row mt-5'><div class='alert alert-danger bg-warning d-flex align-items-center' id='alerta-registro-user' role='alert'>
...
<body class="fondo">
     <?php
        ...
        // }else{
        //     echo "<h1 class='text-white'>NO SE CONECTO </h1>";
        // }
    ?>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        ...
        <section class="container" id="" style=" width: auto; margin: auto auto; margin-top: 5rem;">
            ...
            <div class="row" >
                ...
                <form class="form"  action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="nombre" class="form-label blancoOpaco">Nombre</label>
                        <input class="form-control" id="nombre" name="nombre"rows="3" ></input>
                    </div>
                    <div class="mb-3">
                        <label for="direccion" class="form-label blancoOpaco">Direccion</label>
                        <input class="form-control" id="direccion" name="direccion" rows="3" ></input>
                    </div>
                    <div class="mb-3">
                        <label for="telefono" class="form-label blancoOpaco">Telefono</label>
                        <input class="form-control" id="telefono" name="telefono" rows="3" ></input>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label blancoOpaco">Correo</label>
                        <input type="email" class="form-control" id="correo" name="correo" placeholder="name@example.com">
                    </div>
                    <div class="mb-3">
                        <label for="mensaje" class="form-label blancoOpaco">Mensaje</label>
